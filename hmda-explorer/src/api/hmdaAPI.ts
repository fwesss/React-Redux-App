...
const aggregateData = (
  ...
  readonly size: number;
  readonly slice: string;
  readonly _links: readonly [{ readonly href: string; readonly rel: string }];
  readonly query: {
    readonly group: string | null;
    readonly limit: number;
    readonly offset: number;
